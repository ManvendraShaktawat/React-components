...
const NUMBER_OF_PLAYERS = 2; // max 4
...
const App = () => {
  ...
  const [playerPos, setPlayerPos] = useState(Array(NUMBER_OF_PLAYERS).fill(1));
  ...
  function checkSnakes(newPosArr) {
  ...
  function checkLadder(newPosArr) {
